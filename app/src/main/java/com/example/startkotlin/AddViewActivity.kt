...
class AddViewActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myInflater = LayoutInflater.from(this@AddViewActivity)
        carList.forEach {
            val carItemView = myInflater.inflate(R.layout.car_item, null)
            ...
            carImage.setImageDrawable(resources.getDrawable(R.drawable.img, this.theme))
